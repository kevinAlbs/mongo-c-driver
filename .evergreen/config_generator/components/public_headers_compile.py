...
class PublicHeadersCompile(Function):
    ...
    commands = [
        bash_exec(
            ...
            working_dir='mongoc',
            script='.evergreen/scripts/compile-public-headers.sh',
        ),
    ]
...
def functions():
    return PublicHeadersCompile.defn()
