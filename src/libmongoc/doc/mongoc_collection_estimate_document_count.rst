:man_page: mongoc_collection_estimate_document_count
...
.. code-block:: c
   ...
   int64_t
   mongoc_collection_estimate_document_count (mongoc_collection_t *collection,
...
.. code-block:: c
  ...
  print_count (mongoc_collection_t *collection, bson_t *query)
  {
     ...
     count = mongoc_collection_estimate_document_count (
        collection, NULL, opts, NULL, &error);
     bson_destroy (opts);
