...
_mongoc_topology_run_background (void *data)
{
   ...
   for (;;) {
      ...
      /* TODO: if a scanner node has switched state
       * (short-polling => long-polling or vice versa)
       * then update here:
       * - add async command for long polling
       * - cancel async command for long polling
       */
