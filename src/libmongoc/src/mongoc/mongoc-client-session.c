   ...
   bson_error_t *error)
{
   ...
   while (true) {
    ...
    didn't do it. */
	 ...
	 fprintf (stderr, "unknown callback error.\n");
         GOTO (done);
      }
	 ...
	 fprintf (stderr, "transaction aborted or committed already\n");
         GOTO (done);
      }
	 ...
	 fprintf (stderr, "transaction successfully committed\n");
         GOTO (done);
      }
   }
