   ...
   for (;;) {
      ...
      if (sspi_status == SEC_I_CONTINUE_NEEDED || sspi_status == SEC_E_OK) {
         ...
         case CRYPT_E_NO_REVOCATION_CHECK:
             ...
             * certificate */
            MONGOC_ERROR ("SSL Certification verification failed: certificate does not include revocation check. Set tlsDisableCertificateRevocationCheck to disable revocation checking");
            break;
