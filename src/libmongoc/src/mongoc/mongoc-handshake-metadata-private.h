...
#ifndef MONGOC_HANDSHAKE_METADATA_PRIVATE_H
#define MONGOC_HANDSHAKE_METADATA_PRIVATE_H

#include "bson/bson.h"

typedef struct {
   int32_t max_wire_version;
   int32_t max_bson_object_size;
   int32_t max_message_size_bytes;
   int32_t max_write_batch_size;
} mongoc_handshake_metadata_t;
...
#endif /* MONGOC_HANDSHAKE_METADATA_PRIVATE_H */