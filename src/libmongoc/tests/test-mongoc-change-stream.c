...
{
   mongoc_client_t *client =
      mongoc_client_new_from_uri (mongoc_client_get_uri (ctx->client));
   mongoc_database_t *db = mongoc_client_get_database (
      client, bson_lookup_utf8 (operation, "database"));
   mongoc_collection_t *coll = mongoc_database_get_collection (
      db, bson_lookup_utf8 (operation, "collection"));
