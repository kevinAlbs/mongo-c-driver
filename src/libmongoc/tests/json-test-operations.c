                    ...
                    const json_test_config_t *config)
{
   ...
   if (bson_iter_init_find (&test_iter, test, "useMultipleMongoses") && bson_iter_as_bool (&test_iter)) {
      ctx->test_framework_uri = mongoc_uri_new ("mongodb://localhost:27017,localhost:27018");
   } else {
