...
{
   if (future_wait (future)) {
      return future_value_get_const_mongoc_create_search_index_options_ptr (&future->return_value);
   }
...
{
   if (future_wait (future)) {
      return future_value_get_const_mongoc_update_search_index_options_ptr (&future->return_value);
   }
...
future_get_const_mongoc_drop_search_index_options_ptr (future_t *future)
{
   if (future_wait (future)) {
      return future_value_get_const_mongoc_drop_search_index_options_ptr (&future->return_value);
   }
