...
typedef const mongoc_list_search_indexes_options_t * const_mongoc_list_search_indexes_options_ptr;
...
typedef enum {
   ...
   future_value_const_mongoc_list_search_indexes_options_ptr_type,
...
typedef struct _future_value_t
{
   ...
   union {
      ...
      const_mongoc_list_search_indexes_options_ptr const_mongoc_list_search_indexes_options_ptr_value;
...
future_value_set_const_mongoc_create_search_index_options_ptr(
   future_value_t *future_value,
   const_mongoc_create_search_index_options_ptr value);

const_mongoc_create_search_index_options_ptr
future_value_get_const_mongoc_create_search_index_options_ptr (
   future_value_t *future_value);

void
future_value_set_const_mongoc_search_index_model_ptr(
   future_value_t *future_value,
   const_mongoc_search_index_model_ptr value);
...
future_value_set_const_mongoc_update_search_index_options_ptr(
   future_value_t *future_value,
   const_mongoc_update_search_index_options_ptr value);

const_mongoc_update_search_index_options_ptr
future_value_get_const_mongoc_update_search_index_options_ptr (
   future_value_t *future_value);

void
future_value_set_const_mongoc_drop_search_index_options_ptr(
   future_value_t *future_value,
   const_mongoc_drop_search_index_options_ptr value);
...
future_value_set_const_mongoc_list_search_indexes_options_ptr(
   future_value_t *future_value,
   const_mongoc_list_search_indexes_options_ptr value);

const_mongoc_list_search_indexes_options_ptr
future_value_get_const_mongoc_list_search_indexes_options_ptr (
   future_value_t *future_value);
