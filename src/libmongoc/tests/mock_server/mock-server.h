...
#define RS_RESPONSE_TO_ISMASTER(server, max_wire_version, primary, has_tags, ...) \
   rs_response_to_ismaster (server, max_wire_version, primary, has_tags, __VA_ARGS__, NULL)
