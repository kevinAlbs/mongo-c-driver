...
static void *
background_mongoc_collection_estimate_document_count (void *data)
{
   future_t *future = (future_t *) data;
   future_value_t return_value;
   ...
   future_value_set_int64_t (
      ...
      mongoc_collection_estimate_document_count (
         future_value_get_mongoc_collection_ptr (future_get_param (future, 0)),
         future_value_get_const_mongoc_read_prefs_ptr (future_get_param (future, 1)),
         future_value_get_const_bson_ptr (future_get_param (future, 2)),
         future_value_get_bson_ptr (future_get_param (future, 3)),
         future_value_get_bson_error_ptr (future_get_param (future, 4))
      ));
   ...
   bson_error_ptr error)
{
   ...
   future_value_set_const_mongoc_read_prefs_ptr (
      future_get_param (future, 1), read_prefs);
   ...
   future_start (future, background_mongoc_collection_estimate_document_count);
   return future;
}
