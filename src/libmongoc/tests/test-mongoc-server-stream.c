...
test_server_stream_ties_server_description_pooled (void *unused)
{
   ...
   MONGOC_DEBUG ("Create a connection on client_opquery.");
   ...
   MONGOC_DEBUG ("Create a connection on client_opmsg.");
   ...
   MONGOC_DEBUG ("Re-use client_opquery, to ensure it still uses opquery.");
   future = future_client_command_simple (client_opquery,
                                          "admin",
                                          tmp_bson ("{'ping': 1}"),
                                          NULL /* read prefs */,
   ...
   MONGOC_DEBUG ("Re-use client_opmsg, to ensure it still uses opmsg.");
   future = future_client_command_simple (client_opmsg,
                                          "admin",
                                          tmp_bson ("{'ping': 1}"),
                                          NULL /* read prefs */,
