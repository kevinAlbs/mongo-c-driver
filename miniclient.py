...
"""
request_id = 0
def build_opmsg (payload0_document : bytes, payload1_identifier: str | None = None, payload1_documents: list[bytes] | None = None) -> bytes:
    """
...
def send_opmsg (conn: socket.socket, payload0_document : bytes, payload1_identifier: str | None = None, payload1_documents: list[bytes] | None = None) -> dict:
    # Send a hello.
